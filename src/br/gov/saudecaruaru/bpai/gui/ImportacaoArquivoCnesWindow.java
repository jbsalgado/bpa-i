 ...
 * @author juniorpires
 */
public class ImportacaoArquivoCnesWindow extends javax.swing.JDialog implements ImportacaoArquivoCnesView{

    /**
     * Creates new form ImportacaoArquivoCnesWindow
     */
    public ImportacaoArquivoCnesWindow(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImportacaoArquivoCnesWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ImportacaoArquivoCnesWindow dialog = new ImportacaoArquivoCnesWindow(new javax.swing.JFrame(), true);
