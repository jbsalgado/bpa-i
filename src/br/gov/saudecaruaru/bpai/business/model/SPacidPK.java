 ...
 */
@Embeddable
public class SPacidPK implements Serializable {
    ...
    public SPacidPK(String pacidPa, String pacidCid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SPacidPK)) {
            return false;
        }
        SPacidPK other = (SPacidPK) object;
